  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.wenjuanbianhao" label="问卷编号" prop="wenjuanbianhao">
              <el-input v-model="ruleForm.wenjuanbianhao" 
                placeholder="问卷编号" readonly></el-input>
          </el-form-item>
        </div>
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `kechengwenjuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.kechengwenjuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
