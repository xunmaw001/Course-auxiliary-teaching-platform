<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="课程资源" prop="kechengziyuan">
          <file-upload
          tip="点击上传课程资源"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.kechengziyuan" label="课程资源" prop="kechengziyuan">
            <el-button type="text" size="small" @click="download(ruleForm.kechengziyuan)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.kechengxiangqing = this.ruleForm.kechengxiangqing.replace(reg,'../../../ssm4mr61/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
