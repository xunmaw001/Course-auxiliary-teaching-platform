<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="问卷编号" prop="wenjuanbianhao">
          <el-input v-model="ruleForm.wenjuanbianhao" 
              placeholder="问卷编号" clearable  :readonly="ro.wenjuanbianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="问卷编号" prop="wenjuanbianhao">
              <el-input v-model="ruleForm.wenjuanbianhao" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="问卷名称" prop="wenjuanmingcheng">
          <el-input v-model="ruleForm.wenjuanmingcheng" 
              placeholder="问卷名称" clearable  :readonly="ro.wenjuanmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="问卷名称" prop="wenjuanmingcheng">
              <el-input v-model="ruleForm.wenjuanmingcheng" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="问卷内容" prop="wenjuanneirong">
          <el-input v-model="ruleForm.wenjuanneirong" 
              placeholder="问卷内容" clearable  :readonly="ro.wenjuanneirong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="问卷内容" prop="wenjuanneirong">
              <el-input v-model="ruleForm.wenjuanneirong" 
                placeholder="问卷内容" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="问卷回答" prop="wenjuanhuida">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="问卷回答"
                  v-model="ruleForm.wenjuanhuida" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.wenjuanhuida" label="问卷回答" prop="wenjuanhuida">
                    <span>{{ruleForm.wenjuanhuida}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.banji = true;
          ...
          if(o=='wenjuanmingcheng'){
            this.ruleForm.wenjuanmingcheng = obj[o];
	    this.ro.wenjuanmingcheng = true;
            continue;
          }
          if(o=='wenjuanneirong'){
