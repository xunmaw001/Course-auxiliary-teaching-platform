<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="提问内容" prop="tiwenneirong">
          <el-input v-model="ruleForm.tiwenneirong" 
              placeholder="提问内容" clearable  :readonly="ro.tiwenneirong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="提问内容" prop="tiwenneirong">
              <el-input v-model="ruleForm.tiwenneirong" 
                placeholder="提问内容" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="回答内容" prop="huidaneirong">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.huidaneirong" label="回答内容" prop="huidaneirong">
                    <span>{{ruleForm.huidaneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `kechenghuida/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.kechenghuidaCrossAddOrUpdateFlag = false;
                  this.parent.search();
